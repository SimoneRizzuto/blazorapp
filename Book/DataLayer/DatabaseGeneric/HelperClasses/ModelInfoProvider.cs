...
namespace DL.HelperClasses
{
	...
	internal class ModelInfoProviderCore : ModelInfoProviderBase
	{
		...
		private void Init()
		{
			...
			InitAuthorEntityInfo();
			InitBookEntityInfo();
			InitEfmigrationsHistoryEntityInfo();
		...
		private void InitAspNetUserEntityInfo()
		{
			...
			this.AddElementFieldInfo("AspNetUserEntity", "FirstName", typeof(System.String), false, false, false, false,  (int)AspNetUserFieldIndex.FirstName, 2147483647, 0, 0);
			...
			this.AddElementFieldInfo("AspNetUserEntity", "LastName", typeof(System.String), false, false, false, false,  (int)AspNetUserFieldIndex.LastName, 2147483647, 0, 0);
		...
		private void InitAspNetUserLoginEntityInfo()
		{
			...
			this.AddElementFieldInfo("AspNetUserLoginEntity", "LoginProvider", typeof(System.String), true, false, false, false,  (int)AspNetUserLoginFieldIndex.LoginProvider, 450, 0, 0);
			...
			this.AddElementFieldInfo("AspNetUserLoginEntity", "ProviderKey", typeof(System.String), true, false, false, false,  (int)AspNetUserLoginFieldIndex.ProviderKey, 450, 0, 0);
		...
		private void InitAspNetUserTokenEntityInfo()
		{
			...
			this.AddElementFieldInfo("AspNetUserTokenEntity", "LoginProvider", typeof(System.String), true, false, false, false,  (int)AspNetUserTokenFieldIndex.LoginProvider, 450, 0, 0);
			this.AddElementFieldInfo("AspNetUserTokenEntity", "Name", typeof(System.String), true, false, false, false,  (int)AspNetUserTokenFieldIndex.Name, 450, 0, 0);
		...
		/// <summary>Inits AuthorEntity's info objects</summary>
		private void InitAuthorEntityInfo()
		{
			this.AddFieldIndexEnumForElementName(typeof(AuthorFieldIndex), "AuthorEntity");
			this.AddElementFieldInfo("AuthorEntity", "Bio", typeof(System.String), false, false, false, true,  (int)AuthorFieldIndex.Bio, 250, 0, 0);
			this.AddElementFieldInfo("AuthorEntity", "FirstName", typeof(System.String), false, false, false, true,  (int)AuthorFieldIndex.FirstName, 50, 0, 0);
			this.AddElementFieldInfo("AuthorEntity", "Id", typeof(System.Int32), true, false, true, false,  (int)AuthorFieldIndex.Id, 0, 0, 10);
			this.AddElementFieldInfo("AuthorEntity", "LastName", typeof(System.String), false, false, false, true,  (int)AuthorFieldIndex.LastName, 50, 0, 0);
		}

		/// <summary>Inits BookEntity's info objects</summary>
		private void InitBookEntityInfo()
		{
			this.AddFieldIndexEnumForElementName(typeof(BookFieldIndex), "BookEntity");
			this.AddElementFieldInfo("BookEntity", "AuthorId", typeof(Nullable<System.Int32>), false, true, false, true,  (int)BookFieldIndex.AuthorId, 0, 0, 10);
			this.AddElementFieldInfo("BookEntity", "Id", typeof(System.Int32), true, false, true, false,  (int)BookFieldIndex.Id, 0, 0, 10);
			this.AddElementFieldInfo("BookEntity", "Image", typeof(System.String), false, false, false, true,  (int)BookFieldIndex.Image, 250, 0, 0);
			this.AddElementFieldInfo("BookEntity", "Isbn", typeof(System.String), false, false, false, false,  (int)BookFieldIndex.Isbn, 50, 0, 0);
			this.AddElementFieldInfo("BookEntity", "Price", typeof(Nullable<System.Decimal>), false, false, false, true,  (int)BookFieldIndex.Price, 0, 2, 18);
			this.AddElementFieldInfo("BookEntity", "Summary", typeof(System.String), false, false, false, true,  (int)BookFieldIndex.Summary, 250, 0, 0);
			this.AddElementFieldInfo("BookEntity", "Title", typeof(System.String), false, false, false, true,  (int)BookFieldIndex.Title, 50, 0, 0);
			this.AddElementFieldInfo("BookEntity", "Year", typeof(Nullable<System.Int32>), false, false, false, true,  (int)BookFieldIndex.Year, 0, 0, 10);
		}

		/// <summary>Inits EfmigrationsHistoryEntity's info objects</summary>
		private void InitEfmigrationsHistoryEntityInfo()
		{
			this.AddFieldIndexEnumForElementName(typeof(EfmigrationsHistoryFieldIndex), "EfmigrationsHistoryEntity");
			this.AddElementFieldInfo("EfmigrationsHistoryEntity", "MigrationId", typeof(System.String), true, false, false, false,  (int)EfmigrationsHistoryFieldIndex.MigrationId, 150, 0, 0);
			this.AddElementFieldInfo("EfmigrationsHistoryEntity", "ProductVersion", typeof(System.String), false, false, false, false,  (int)EfmigrationsHistoryFieldIndex.ProductVersion, 32, 0, 0);
		}
	}
}