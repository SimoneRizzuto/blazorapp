...
namespace DL.EntityClasses
{
	...
	
	{
		...
		protected class AspNetRoleEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AspNetRoleEntity", InheritanceHierarchyType.None, false, (int)DL.EntityType.AspNetRoleEntity, typeof(AspNetRoleEntity), typeof(AspNetRoleEntityFactory), false);
				AddNavigatorMetaData<AspNetRoleEntity, EntityCollection<AspNetRoleClaimEntity>>("AspNetRoleClaims", a => a._aspNetRoleClaims, (a, b) => a._aspNetRoleClaims = b, a => a.AspNetRoleClaims, () => new AspNetRoleRelations().AspNetRoleClaimEntityUsingRoleId, typeof(AspNetRoleClaimEntity), (int)DL.EntityType.AspNetRoleClaimEntity);
				AddNavigatorMetaData<AspNetRoleEntity, EntityCollection<AspNetUserRoleEntity>>("AspNetUserRoles", a => a._aspNetUserRoles, (a, b) => a._aspNetUserRoles = b, a => a.AspNetUserRoles, () => new AspNetRoleRelations().AspNetUserRoleEntityUsingRoleId, typeof(AspNetUserRoleEntity), (int)DL.EntityType.AspNetUserRoleEntity);
			}
		}
