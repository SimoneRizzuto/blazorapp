...
namespace DL.EntityClasses
{
	...
	
	{
		...
		protected class AspNetUserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AspNetUserEntity", InheritanceHierarchyType.None, false, (int)DL.EntityType.AspNetUserEntity, typeof(AspNetUserEntity), typeof(AspNetUserEntityFactory), false);
				AddNavigatorMetaData<AspNetUserEntity, EntityCollection<AspNetUserClaimEntity>>("AspNetUserClaims", a => a._aspNetUserClaims, (a, b) => a._aspNetUserClaims = b, a => a.AspNetUserClaims, () => new AspNetUserRelations().AspNetUserClaimEntityUsingUserId, typeof(AspNetUserClaimEntity), (int)DL.EntityType.AspNetUserClaimEntity);
				AddNavigatorMetaData<AspNetUserEntity, EntityCollection<AspNetUserLoginEntity>>("AspNetUserLogins", a => a._aspNetUserLogins, (a, b) => a._aspNetUserLogins = b, a => a.AspNetUserLogins, () => new AspNetUserRelations().AspNetUserLoginEntityUsingUserId, typeof(AspNetUserLoginEntity), (int)DL.EntityType.AspNetUserLoginEntity);
				AddNavigatorMetaData<AspNetUserEntity, EntityCollection<AspNetUserRoleEntity>>("AspNetUserRoles", a => a._aspNetUserRoles, (a, b) => a._aspNetUserRoles = b, a => a.AspNetUserRoles, () => new AspNetUserRelations().AspNetUserRoleEntityUsingUserId, typeof(AspNetUserRoleEntity), (int)DL.EntityType.AspNetUserRoleEntity);
				AddNavigatorMetaData<AspNetUserEntity, EntityCollection<AspNetUserTokenEntity>>("AspNetUserTokens", a => a._aspNetUserTokens, (a, b) => a._aspNetUserTokens = b, a => a.AspNetUserTokens, () => new AspNetUserRelations().AspNetUserTokenEntityUsingUserId, typeof(AspNetUserTokenEntity), (int)DL.EntityType.AspNetUserTokenEntity);
			}
		}
		...
		/// <summary>The FirstName property of the Entity AspNetUser<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AspNetUsers"."FirstName".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 2147483647.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String FirstName
		{
			get { return (System.String)GetValue((int)AspNetUserFieldIndex.FirstName, true); }
			set	{ SetValue((int)AspNetUserFieldIndex.FirstName, value); }
		}
		...
		/// <summary>The LastName property of the Entity AspNetUser<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AspNetUsers"."LastName".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 2147483647.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String LastName
		{
			get { return (System.String)GetValue((int)AspNetUserFieldIndex.LastName, true); }
			set	{ SetValue((int)AspNetUserFieldIndex.LastName, value); }
		}
