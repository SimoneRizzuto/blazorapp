...
namespace DL.EntityClasses
{
	...
	
	{
		...
		protected class AspNetRoleClaimEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AspNetRoleClaimEntity", InheritanceHierarchyType.None, false, (int)DL.EntityType.AspNetRoleClaimEntity, typeof(AspNetRoleClaimEntity), typeof(AspNetRoleClaimEntityFactory), false);
				AddNavigatorMetaData<AspNetRoleClaimEntity, AspNetRoleEntity>("AspNetRole", "AspNetRoleClaims", (a, b) => a._aspNetRole = b, a => a._aspNetRole, (a, b) => a.AspNetRole = b, DL.RelationClasses.StaticAspNetRoleClaimRelations.AspNetRoleEntityUsingRoleIdStatic, ()=>new AspNetRoleClaimRelations().AspNetRoleEntityUsingRoleId, null, new int[] { (int)AspNetRoleClaimFieldIndex.RoleId }, null, true, (int)DL.EntityType.AspNetRoleEntity);
			}
		}
