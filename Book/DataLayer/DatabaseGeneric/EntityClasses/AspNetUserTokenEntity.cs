...
namespace DL.EntityClasses
{
	...
	
	{
		...
		protected class AspNetUserTokenEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AspNetUserTokenEntity", InheritanceHierarchyType.None, false, (int)DL.EntityType.AspNetUserTokenEntity, typeof(AspNetUserTokenEntity), typeof(AspNetUserTokenEntityFactory), false);
				AddNavigatorMetaData<AspNetUserTokenEntity, AspNetUserEntity>("AspNetUser", "AspNetUserTokens", (a, b) => a._aspNetUser = b, a => a._aspNetUser, (a, b) => a.AspNetUser = b, DL.RelationClasses.StaticAspNetUserTokenRelations.AspNetUserEntityUsingUserIdStatic, ()=>new AspNetUserTokenRelations().AspNetUserEntityUsingUserId, null, new int[] { (int)AspNetUserTokenFieldIndex.UserId }, null, true, (int)DL.EntityType.AspNetUserEntity);
			}
		}
		...
		/// <remarks>Mapped on  table field: "AspNetUserTokens"."LoginProvider".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 450.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		...
		/// <remarks>Mapped on  table field: "AspNetUserTokens"."Name".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 450.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
